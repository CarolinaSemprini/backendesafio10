...
class ProductManager{
    ...
    static isValidProduct = (product) => {
        ...
        //if (product.thumbnails && product.thumbnails.some(thumbnail => typeof thumbnail !== 'string')) 
        return true;
      }
    ...
    deleteProducts = async (id) => {
        ...
        let existingProduct = products.find((prod) => prod.id === id);
        if (existingProduct) {
          // Filtrar todos los productos cuyo ID sea DISTINTO AL ID QUE RECIBO
